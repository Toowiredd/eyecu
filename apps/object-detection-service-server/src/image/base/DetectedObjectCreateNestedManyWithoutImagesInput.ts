...
@InputType()
class DetectedObjectCreateNestedManyWithoutImagesInput {
...
export { DetectedObjectCreateNestedManyWithoutImagesInput as DetectedObjectCreateNestedManyWithoutImagesInput };
